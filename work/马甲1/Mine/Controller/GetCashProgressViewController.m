...
-(void)call
{
    UIAlertController *alertVC = [UIAlertController alertControllerWithTitle:@"联系客服" message:@"010-53350021" preferredStyle:UIAlertControllerStyleAlert];
